...
export default function AboutUs(): JSX.Element {
    return (
        ...
        <div style={{ marginTop: '100px', margin: '1rem 2rem 1rem 2rem' }}>
            <h1 style={{ fontWeight: 'bold', color: 'white', fontSize: '30px' }}>Почему вам стоит выбрать нас?</h1>
            ...
            <center>
                <h1 style={{ fontWeight: 'bold', color: 'white', marginTop: '20px', fontSize: '30px' }}>Наши инструменты</h1>
            </center>
            <DescriptionCardPage />
        </div>
    );
